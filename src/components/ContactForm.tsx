...
const ContactForm = () => {
  ...
  return (
    <motion.div 
      className="max-w-md mx-auto bg-sylonow-dark/60 backdrop-blur-lg border border-sylonow-purple/20 p-8 rounded-xl shadow-lg"
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      placeholder="Name"
                      className="w-full bg-sylonow-dark/50 border-sylonow-purple/30 text-white"
                      {...field}
                    />
                  </FormControl>
                </FormItem>

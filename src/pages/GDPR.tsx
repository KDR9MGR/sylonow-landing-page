...
const GDPR = () => {
  ...
  const userRights = [
    ...
    },
    {
      ...
      description:
        "You can request correction or completion of your personal data if it is inaccurate or incomplete.",
    },
    {
      icon: Trash2,
    ...
    },
    {
      ...
      description:
        "You can request to restrict the processing of your personal data under certain circumstances.",
    },
    {
      icon: Download,
      title: "Right to Data Portability",
      description:
        "You can request to receive your data in a structured format or have it transferred to another controller.",
    },
    {
      icon: Shield,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about your rights under GDPR and how Sylonow protects your personal data."
        />
      </Helmet>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  enhanced rights regarding your personal data. We are committed
                  to protecting these rights and ensuring transparency in our
                ...
                <p className="text-gray-600 mb-6">
                  We process personal data only with valid legal bases under
                  GDPR, including:
                </p>
                <ul className="list-disc pl-6 text-gray-600 mb-6">
                  <li>Consent: When you explicitly agree to the processing</li>
                  <li>
                    Contract: When processing is necessary for a contract with
                    you
                  </li>
                  <li>Legal Obligation: When required by law</li>
                  <li>
                    Legitimate Interests: When we have a justified business
                    purpose
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-6">
                  When we transfer personal data outside the EEA, we ensure
                  appropriate safeguards are in place through standard
                ...
                <p className="text-gray-600 mb-6">
                  To exercise your GDPR rights or if you have any questions
                  about our data protection practices, please contact our Data

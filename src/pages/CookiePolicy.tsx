...
const CookiePolicy = () => {
  ...
  const cookieCategories = [
    ...
    },
    {
      ...
      description: "These cookies enable enhanced functionality and personalization, such as live chat services and remembering your preferences.",
      required: false
    }
  ];
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  analyzing how you use our site, and helping with marketing efforts.
                </p>

                <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">How We Use Cookies</h2>
                <p className="text-gray-600 mb-6">
                  We use different types of cookies for various purposes. Some cookies are essential 
                  for the website to function properly, while others help us improve our services 
                  and your experience.
                </p>
